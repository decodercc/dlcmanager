...
{
    [Info("Blueprints Manager + DLC", "Decoder", "1.0.0")]
    ...
    public class DLCManager : RustPlugin
    {
        ...
        protected override void LoadDefaultMessages()
        {
            ...
            {
                {"Usage", "Usage:\n" +
                          " * dlcmanager reset 'player name or id' - resets blueprints for player\n" +
                          " * dlcmanager unlock 'player name or id' 'item shortname' - unlock specified blueprint for player\n" +
                          " * dlcmanager unlockall 'player name or id'- unlocks all blueprints for player"},
